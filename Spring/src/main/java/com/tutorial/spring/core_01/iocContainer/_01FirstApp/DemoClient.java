...
*/		
		...
		Resource  res=new ClassPathResource("com/tutorial/spring/core_01/iocContainer/_01FirstApp/spring.cfg.xml");

		//activation of  spring container & reading spring configuration file
		BeanFactory  factory=new XmlBeanFactory(res);

		//getting object of implementation class
		//DemoInter d = (DemoInter)factory.getBean("com.tutorial.spring.core_01.iocContainer._01FirstApp.DemoInterImpl");
		
		
		DemoInterImpl d = new DemoInterImpl(); //(DemoInterImpl)factory.getBean("com.tutorial.spring.core_01.iocContainer._01FirstApp.DemoInterImpl");
		d = (DemoInterImpl)factory.getBean("com.tutorial.spring.core_01.iocContainer._01FirstApp.DemoInterImpl");
		
		DemoInterImpl d2 = (DemoInterImpl)factory.getBean("com.tutorial.spring.core_01.iocContainer._01FirstApp.DemoInterImpl");
		DemoInterImpl d3 = (DemoInterImpl)factory.getBean("com.tutorial.spring.core_01.iocContainer._01FirstApp.DemoInterImpl");
